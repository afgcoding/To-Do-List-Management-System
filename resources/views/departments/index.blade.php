...
<div class="mx-auto max-w-7xl space-y-6"
    ...
    {{-- Filters --}}
    <form method="GET" action="{{ route('departments.index') }}" class="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-[1fr_12rem_auto]">
        ...
        <button class="rounded-xl border border-slate-300 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-100">Filter</button>
    </form>
