    ...
    <div>
        ...
        <div class="flex gap-3">
            <label class="flex cursor-pointer items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50/60">
                <input type="radio" name="status" value="active" class="text-indigo-600 focus:ring-indigo-500" @checked(old('status', $user?->status ?? 'active') === 'active')>
                Active
            </label>
            <label class="flex cursor-pointer items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50/60">
                <input type="radio" name="status" value="inactive" class="text-indigo-600 focus:ring-indigo-500" @checked(old('status', $user?->status) === 'inactive')>
                Inactive
            </label>
        </div>
